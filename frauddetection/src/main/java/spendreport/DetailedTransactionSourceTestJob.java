...
/**
 * Test job to verify DetailedTransactionSource functionality.
 * This job generates transactions and prints them to console for verification.
 */
public class DetailedTransactionSourceTestJob {
    ...
    public static void main(String[] args) throws Exception {
        ...
        env.execute("Detailed Transaction Source Test");
    }
}
